	...
	public function init() {
		...
		if ( $this->time_to_show_notice() ) {
			$params = [
				...
				'notice_text'  => __( 'Hey, I noticed you have been using %sPublishPress%s for a few weeks - that\'s awesome! May I ask you to give it a %s5-star%s rating on WordPress? Just to help us spread the word and boost our motivation.',
					'publishpress' ),
			];
