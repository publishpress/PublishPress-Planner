...
class PP_User_Groups extends PP_Module {
	...
	function print_configure_view() {
		...
		<div id="col-left"><div class="col-wrap"><div class="form-wrap">
			...
			<div class="form-field form-required">
				<label for="name"><?php _e( 'Name', 'publishpress' ); ?></label>
			...
			<div class="form-field">
				<label for="description"><?php _e( 'Description', 'publishpress' ); ?></label>
		...
		?>
			...
			<div id="col-left"><div class="col-wrap"><div class="form-wrap">
				<h3 class="nav-tab-wrapper">
					<a href="<?php echo esc_url( $this->get_link() ); ?>" class="nav-tab<?php if ( !isset( $_GET['action'] ) || $_GET['action'] != 'change-options' ) echo ' nav-tab-active'; ?>"><?php _e( 'Add New', 'publishpress' ); ?></a>
					<a href="<?php echo esc_url( $this->get_link( array( 'action' => 'change-options' ) ) ); ?>" class="nav-tab<?php if ( isset( $_GET['action'] ) && $_GET['action'] == 'change-options' ) echo ' nav-tab-active'; ?>"><?php _e( 'Options', 'publishpress' ); ?></a>
				</h3>
	...
	function usergroups_select_form( $selected = array(), $args = null ) {
		...
		if ( empty($usergroups) ) {
			?>
			<p><?php _e('No user groups were found.', 'publishpress') ?> <a href="<?php echo esc_url( $this->get_link() ); ?>" title="<?php _e('Add a new user group. Opens new window.', 'publishpress' ) ?>" target="_blank"><?php _e( 'Add a User Group', 'publishpress' ); ?></a></p>
			<?php
		} else {
	...
	<form method="get" action=""><table style="display: none"><tbody id="inlineedit">
		<tr id="inline-edit" class="inline-edit-row" style="display: none"><td colspan="<?php echo $this->get_column_count(); ?>" class="colspanchange">
			<fieldset><div class="inline-edit-col">
				...
				<label>
					<span class="title"><?php _e( 'Name', 'publishpress' ); ?></span>
					<span class="input-text-wrap"><input type="text" name="name" class="ptitle" value="" maxlength="40" /></span>
				</label>
				<label>
					<span class="title"><?php _e( 'Description', 'publishpress' ); ?></span>
