...
class PP_Notifications extends PP_Module {
	...
	var $following_usergroups_taxonomy = PP_User_Groups::taxonomy_key;
	...
	function __construct () {
		...
		$args = array(
			...
			'short_description' => __( 'Update your team of important changes to your content.', 'publishpress' ),
...
jQuery(document).ready(function($) {
	...
	function notifications_meta_box() {
		...
		<div id="ef-post_following_box">
			...
			<p><?php _e( 'Select the users and user groups that should receive notifications when the status of this post is updated or when an editorial comment is added.', 'publishpress' ); ?></p>
