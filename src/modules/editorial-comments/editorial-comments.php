...
class PP_Editorial_Comments extends PP_Module
{
	...
	function the_comment_form( ) {
		...
		?>
		<a href="#" id="ef-comment_respond" onclick="editorialCommentReply.open();return false;" class="button-primary alignright hide-if-no-js" title=" <?php _e( 'Respond to this post', 'publishpress' ); ?>"><span><?php _e( 'Respond to this post', 'publishpress' ); ?></span></a>
		...
		<div id="ef-replyrow" style="display: none;">
			...
			<p id="ef-replysubmit">
				...
				<a class="ef-replycancel button-secondary alignright" href="#comments-form"><?php _e( 'Cancel', 'publishpress' ); ?></a>
