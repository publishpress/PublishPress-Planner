...
class PP_Story_Budget extends PP_Module {
	...
	function story_budget() {
		...
		<div class="wrap" id="ef-story-budget-wrap">
			<div id="ef-story-budget-title">
				...
				<h2><?php _e( 'Story Budget', 'publishpress' ); ?>&nbsp;<span class="time-range"><?php $this->story_budget_time_range(); ?></span></h2>
	...
	<div class="postbox<?php if ( !empty( $posts )) echo ' postbox-has-posts'; ?>">
		<div class="handlediv" title="<?php _e( 'Click to toggle', 'publishpress' ); ?>"><br /></div>
		...
		<div class="inside">
			...
			<?php else: ?>
			<div class="message info"><p><?php _e( 'There are no posts for this term in the range or filter specified.', 'publishpress' ); ?></p></div>
			<?php endif; ?>
		</div>
	</div>
	<?php
	...
	<div class="tablenav" id="ef-story-budget-tablenav">
		...
		<div class="print-box" style="float:right; margin-right: 30px;"><!-- Print link -->
			<a href="#" id="print_link"><?php _e( 'Print', 'publishpress' ); ?></a>
		</div>
		<div class="clear"></div>
