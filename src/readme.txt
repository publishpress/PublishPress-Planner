...
* [Editorial Comments](https://pressshack.com/features/editorial-comments/) - Threaded commenting in the admin for private discussion between writers and editors.
* [Editorial Metadata](https://pressshack.com/features/editorial-metadata/) - Keep track of the important details.
* [Notifications](https://pressshack.com/features/notifications/) - Receive timely updates on the content you're following.
* [Story Budget](https://pressshack.com/features/story-budget/) - View your upcoming content budget.
* [User Groups](https://pressshack.com/features/user-groups/) - Keep your users organized by department or function.

More details for each feature, screenshots and documentation can be found on [our website](https://pressshack.com/).

We'd love to hear from you! For support questions, feedback and ideas, please use the [WordPress.org forums](http://wordpress.org/tags/publishpress?forum_id=10), which we look at often. If you'd like to contribute code, [we'd love to have you involved](https://pressshack.com/contribute/).
...
* Improvement: Japanese localization 100% on [translate.wordpress.org](https://translate.wordpress.org/locale/ja/default/wp-plugins/publishpress)
...
* New `publishpress_supported_module_post_types_args` filter allows you to enable custom statuses and other modules for private post types
...
* [Read the full release post](https://pressshack.com/2012/01/09/publishpress-v0-7-modular-architecture-monthly-calendar-and-sortable-statuses/)

= 0.6.5 (Sept. 19, 2011) =
* Bug fix: Workaround for a bug in core where the timestamp is set when a post is saved with a custom status. Instead, we update the timestamp on publish to current time if a custom post date hasn't been set. Thanks saomay for [help tracking the bug down](http://wordpress.org/support/topic/plugin-publishpress-custom-statuses-create-timestamp-problem/).
