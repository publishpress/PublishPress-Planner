    ...
    public function column_default($item, $column_name)
    {
        ...
        switch ($column_name) {
            case 'event':
                ...
                $output .= '<div>' . sprintf(__('Workflow: %s', 'publishpress'), '<a target="_blank" href="' . admin_url('post.php?post=' . esc_attr($log->workflowId) . '&action=edit') . '">' . $log->workflowTitle . '</a>') . '</div>';
            ...
            case 'content':
                ...
                $output = '<a target="_blank" href="' . admin_url('post.php?post=' . esc_attr($log->postId) . '&action=edit') . '">' . $log->postTitle . '</a>';
 ...
 */
private
function getCronTaskTimeRelatedToTheLog(NotificationsLogModel $log)
{
