jQuery(document).ready(function ($) {
    ...
    $(document).on('click', 'div.pp-show-revision-btn', function(e) {
        ...
        if (!$('div.pp-content-calendar-filters button.revision_status').hasClass('active-filter')) {
            if ($('#pp-content-filters select#post_status').val() == '_') {
                $('#pp-content-filters select#post_status').val('');
                $('#pp-content-filters select#post_status').trigger('change');
            }
        }
    });
